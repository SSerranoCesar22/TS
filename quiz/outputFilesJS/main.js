...
form === null || form === void 0 ? void 0 : form.addEventListener("click", function (event) {
    event.preventDefault();
    const selectedButton = document.querySelector(".answer.active");
    if (selectedButton) {
...
function updateScore() {
    const scorrect = document.getElementById("correct");
    const sfail = document.getElementById("fail");
